@echo off
REM Hermes OTG — TUI Launcher
REM Opens the Hermes TUI in OTG mode (no install wizard).
...
REM ---- Clean stale runtime files (from crashed/force-killed sessions) ----
...
echo Starting Hermes OTG...
echo.

"%SCRIPT_DIR%Hermes-OTG\Hermes-OTG.exe"
